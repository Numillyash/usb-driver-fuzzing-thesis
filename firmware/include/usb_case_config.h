 ...
 * - 060/062/063/064/065/066 -> composite CDC+MSC persona (CDC diagnostic + read-only RAM-backed MSC)
...
#elif (USB_CASE_ID == 60u) || (USB_CASE_ID == 62u) || (USB_CASE_ID == 63u) || (USB_CASE_ID == 64u) || (USB_CASE_ID == 65u) || (USB_CASE_ID == 66u)
