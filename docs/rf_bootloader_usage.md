...
- Если в диагностике ESP32-C3 `bootloader_req pre` поле `RF_CH` равно `0x02` (или дефолтному значению чипа), значит bridge не восстановил RFTEST-конфигурацию перед отправкой (`RF_CH=0x28`, `TX_ADDR/RX_ADDR_P0=d2:f1:c0:5a:11`, payload 16 байт).
