# Сводка устойчивости Linux USB-стека (completed runs)
...
Завершён отдельный Linux-only блок MSC-кейсов `050-059`; подробности вынесены в [linux_msc_summary.md](linux_msc_summary.md).
